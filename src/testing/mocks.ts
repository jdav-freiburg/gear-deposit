import { AuthUser, convert, Item, ItemStack, RegisteredUser, Reservation, UserAuthStatus } from '../app/model/';
...
export namespace Mocks {
    ...
    export function createItemStacks(size: number): ItemStack[] {
        return convert(Mocks.createComplexMockItems(size, 5));
    }
